...
function ProductDetailsSection({ product }) {
  ...
  return (
    <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16" key={product._id}>
        ...
        <div className="flex flex-col">
          ...
          {/* <div className="flex items-center gap-2">
                        <div className="flex items-center gap-0.5">
                            <Image className="h-4 w-4" src="" alt="star_icon" />
                            <Image className="h-4 w-4" src="" alt="star_icon" />
                            <Image className="h-4 w-4" src="" alt="star_icon" />
                            <Image className="h-4 w-4" src="" alt="star_icon" />
                            <Image
          ...
          <div className="flex items-center mt-10 gap-4">
            ...
            <button
              onClick={() => {}}
              className=" w-full py-3.5 bg-red-500 text-white hover:bg-orange-600 transition cursor-pointer"
            >
              Buy now
            </button>
          </div>
